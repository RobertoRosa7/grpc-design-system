package br.com.orderflow.document.infra.config.chaos;
...
public class ChaosInterceptorConfig {
  ...
  public static final class ChaosInterceptor implements ServerInterceptor {
    ...
    public ChaosInterceptor(ChaosProperties props) {
      this.props = props;
    }
